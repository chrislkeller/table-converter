...
var DataGridRenderer = {
    ...
    html: function(dataGrid, headerNames, headerTypes, indent, newLine, id, classname){
        //inits...
        var commentLine = "<!--";
        var commentLineEnd = "-->";
        var outputText = "";
        ...
        for (var i=0; i<numRows; i++){
            ...
            for (var j=0; j<numColumns; j++){
                outputText += indent + indent + indent;
                outputText += '<td class="' + headerTypes[j] + " " + headerNames[j] + '_cell">';
                outputText += "<mark>" + headerNames[j] + "</mark>";
                outputText += row[j];
